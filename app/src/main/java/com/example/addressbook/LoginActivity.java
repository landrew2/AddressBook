...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView btnSignIn = (TextView) findViewById(R.id.sign_in_button);
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                // Web Client ID hardcoded also in strings.xml
                .requestIdToken("1097866758962-dhpet46vumeqlkhn5iimebd2jp9lf2nn.apps.googleusercontent.com")
                .requestEmail()
                .build();
